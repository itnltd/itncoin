Contributing to ITN Core
============================

The ITN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ITN Core project, and is not to be
confused with overall ITN Network Protocol consensus changes.

Whether a pull request is merged into ITN Core rests with the project merge
...
Patches that change ITN consensus rules are considerably more involved than
...
Where a patch set proposes to change the ITN consensus, it must have been
...
The project leader is the release manager for each ITN Core release.
