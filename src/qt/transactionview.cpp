 ...
 */
    ...
    typeWidget->addItem(tr("Received ITN from zITN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zITN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zITN));
