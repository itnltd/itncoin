                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzitnPathCustom = GetArg("-zitnbackuppath", "");
    ...
    if(!strzitnPathCustom.empty()) {
        ui->wallet_customzitnbackuppath->setText(QString::fromStdString(strzitnPathCustom));
        ui->wallet_customzitnbackuppath_label->setVisible(true);
        ui->wallet_customzitnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzitnPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ITN RPC console.") + "<br>" +
