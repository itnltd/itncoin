...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ITN);
    unitlist.append(mITN);
    unitlist.append(uITN);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ITN:
            return QString("tITN");
        case mITN:
            return QString("mtITN");
        case uITN:
            return QString::fromUtf8("μtITN");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ITN:
            return QString("ITN");
        case mITN:
            return QString("Milli-ITN (1 / 1" THIN_SP_UTF8 "000)");
        case uITN:
            return QString("Micro-ITN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case ITN:
            return QString("TestITNs");
        case mITN:
            return QString("Milli-TestITN (1 / 1" THIN_SP_UTF8 "000)");
        case uITN:
            return QString("Micro-TestITN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
