                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ITN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ITN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and itn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zITN"));
...
//    tabGroup->addAction(proposalAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ITN Core"), this);
    aboutAction->setStatusTip(tr("Show information about ITN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ITN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ITN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ITN addresses"));
    ...
    openAction->setStatusTip(tr("Open a ITN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ITN Core help message to get a list with possible ITN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ITN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ITN network", "", count));
}
...
{
    QString strTitle = tr("ITN Core"); // default title
