...
/* ITN GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ITN"
#define QAPP_ORG_DOMAIN "itn.ltd"
#define QAPP_APP_NAME_DEFAULT "ITN-Qt"
#define QAPP_APP_NAME_TESTNET "ITN-Qt-testnet"
