...
#if defined(NDEBUG)
#error "ITN cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 7 * 24 * 60 * 60;
int64_t nReserveBalance = 0;

/** Fees smaller than this (in uITN) are considered zero fee (for relaying and mining)
...
bool ContextualCheckZerocoinSpend(const CTransaction& tx, const CoinSpend& spend, CBlockIndex* pindex, const uint256& hashBlock) {
    //Check to see if the zITN is properly signed
    if (pindex->nHeight > Params().Zerocoin_LastOldParams()) {
        if (!spend.HasValidSignature())
            return error("%s: V2 zITN spend does not have a valid signature", __func__);

        libzerocoin::SpendType expectedType = libzerocoin::SpendType::SPEND;
        if (tx.IsCoinStake())
            expectedType = libzerocoin::SpendType::STAKE;
        if (spend.getSpendType() != expectedType) {
            return error("%s: trying to spend zITN without the correct spend type. txid=%s", __func__,
                         tx.GetHash().GetHex());
        }
    }
    ...
    if (IsSerialInBlockchain(spend.getCoinSerialNumber(), nHeightTx))
        return error("%s : zITN spend with serial %s is already in block %d\n", __func__,
    ...
    if (!spend.HasValidSerial(paramsToUse))
        return error("%s : zITN spend with serial %s from tx %s is not in valid range\n", __func__,
...

    {
        ...
        if(tx.IsZerocoinSpend()){
            ...
            if (IsTransactionInChain(tx.GetHash(), nHeightTx))
                return state.Invalid(error("AcceptToMemoryPool : zITN spend tx %s already in block %d",
            ...
            for (const CTxIn& txIn : tx.vin) {
                ...
                if (!ContextualCheckZerocoinSpend(tx, spend, chainActive.Tip(), 0))
                    return state.Invalid(error("%s: ContextualCheckZerocoinSpend failed for tx %s", __func__,
                                               tx.GetHash().GetHex()), REJECT_INVALID, "bad-txns-invalid-zitn");
            }
        } else {
            LOCK(pool.cs);
            ...
            // Check that zITN mints are not already known
            if (tx.IsZerocoinMint()) {
                for (auto& out : tx.vout) {
                    if (!out.IsZerocoinMint())
                        continue;
...
int64_t GetBlockValue(int nHeight)
{
    ...
    switch (nHeight) {
        case                  1:    nSubsidy =  33333333 * COIN; break;
        case          2 ... 5100:   nSubsidy =  0.1 * COIN; break;
        case      5101 ... 21600:   nSubsidy =  7 * COIN; break;
        case     21601 ... 22926:   nSubsidy =  10 * COIN; break;
        case     22927 ... 43200:   nSubsidy =  8 * COIN; break;
        case     43201 ... 64800:   nSubsidy =  6.5 * COIN; break;
        case     64801 ... 86400:   nSubsidy =  5.5 * COIN; break;
        case     86401 ... 108000:  nSubsidy =  7 * COIN; break;
        case    108001 ... 129600:  nSubsidy =  9 * COIN; break;
        case    129601 ... 151200:  nSubsidy =  11 * COIN; break;
        case    151201 ... 172800:  nSubsidy =  7 * COIN; break;
        case    172801 ... 194400:  nSubsidy =  9 * COIN; break;
        case    194401 ... 216000:  nSubsidy =  8 * COIN; break;
        case    216001 ... 237600:  nSubsidy =  13 * COIN; break;
        case    237601 ... 259200:  nSubsidy =  12 * COIN; break;
        case    259201 ... 280800:  nSubsidy =  13 * COIN; break;
        case    280801 ... 302400:  nSubsidy =  9 * COIN; break;
        case    302401 ... 324000:  nSubsidy =  13 * COIN; break;
        case    324001 ... 345600:  nSubsidy =  12 * COIN; break;
        case    345601 ... 367200:  nSubsidy =  10 * COIN; break;
        case    367201 ... 388800:  nSubsidy =  18 * COIN; break;
        case    388801 ... 410400:  nSubsidy =  14 * COIN; break;
        case    410401 ... 432000:  nSubsidy =  17 * COIN; break;
        case    432001 ... 453600:  nSubsidy =  13 * COIN; break;
        case    453601 ... 475200:  nSubsidy =  22 * COIN; break;
        case    475201 ... 496800:  nSubsidy =  21 * COIN; break;
        case    496801 ... 518400:  nSubsidy =  25 * COIN; break;
        case    518401 ... 540000:  nSubsidy =  17 * COIN; break;
        case    540001 ... 561600:  nSubsidy =  25 * COIN; break;
        case    561601 ... 583200:  nSubsidy =  30 * COIN; break;
        case    583201 ... 604800:  nSubsidy =  24 * COIN; break;
        case    604801 ... 626400:  nSubsidy =  21 * COIN; break;
        case    626401 ... 648000:  nSubsidy =  36 * COIN; break;
        case    648001 ... 669600:  nSubsidy =  28 * COIN; break;
        case    669601 ... 691200:  nSubsidy =  25 * COIN; break;
        case    691201 ... 712800:  nSubsidy =  37 * COIN; break;
        case    712801 ... 734400:  nSubsidy =  35 * COIN; break;
        case    734401 ... 756000:  nSubsidy =  30 * COIN; break;
        case    756001 ... 777600:  nSubsidy =  50 * COIN; break;
        case    777601 ... 799200:  nSubsidy =  45 * COIN; break;
        case    799201 ... 820800:  nSubsidy =  42 * COIN; break;
        case    820801 ... 842400:  nSubsidy =  60 * COIN; break;
        case    842401 ... 864000:  nSubsidy =  55 * COIN; break;
        case    864001 ... 885600:  nSubsidy =  42 * COIN; break;
        case    885601 ... 907200:  nSubsidy =  63 * COIN; break;
        case    907201 ... 928800:  nSubsidy =  58 * COIN; break;
        case    928801 ... 950400:  nSubsidy =  50 * COIN; break;
        case    950401 ... 972000:  nSubsidy =  85 * COIN; break;
        case    972001 ... 993600:  nSubsidy =  70 * COIN; break;
        case    993601 ... 1015200: nSubsidy =  85 * COIN; break;
        case   1015201 ... 1036800: nSubsidy =  62 * COIN; break;
        case   1036801 ... 1058400: nSubsidy =  105 * COIN; break;
        case   1058401 ... 1080000: nSubsidy =  85 * COIN; break;
        case   1080001 ... 1101600: nSubsidy =  120 * COIN; break;
        case   1101601 ... 1123200: nSubsidy =  95 * COIN; break;
        case   1123201 ... 1144800: nSubsidy =  115 * COIN; break;
        case   1144801 ... 1166400: nSubsidy =  90 * COIN; break;
        case   1166401 ... 1188000: nSubsidy =  135 * COIN; break;
        case   1188001 ... 1209600: nSubsidy =  165 * COIN; break;
        case   1209601 ... 1231200: nSubsidy =  130 * COIN; break;
        case   1231201 ... 1252800: nSubsidy =  115 * COIN; break;
        case   1252801 ... 1274400: nSubsidy =  170 * COIN; break;
        case   1274401 ... 1296000: nSubsidy =  160 * COIN; break;
                           default: nSubsidy =  3 * COIN; break;
    }
...
bool DisconnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool* pfClean)
{
    ...
    for (int i = block.vtx.size() - 1; i >= 0; i--) {
         ...
         * note we only undo zerocoin databasing in the following statement, value to and from ITN
...
{
    RenameThread("itn-scriptch");
    scriptcheckqueue.Thread();
}

void RecalculateZITNMinted()
{
...
void RecalculateZITNSpent()
{
    ...
    while (true) {
        ...
        //Remove spends from zITN supply
...
bool RecalculateITNSupply(int nHeightStart)
{
...
{
    // ITN: recalculate Accumulator Checkpoints that failed to database properly
...
bool UpdateZITNSupply(const CBlock& block, CBlockIndex* pindex)
{
    std::list<CZerocoinMint> listMints;
    BlockToZerocoinMintList(block, listMints);
...
//    LogPrintf("XX69----------> ConnectBlock(): nValueOut: %s, nValueIn: %s, nFees: %s, nMint: %s zITNSpent: %s\n",
...
void static UpdateTip(CBlockIndex* pindexNew)
{
    ...
    // If turned on AutoZeromint will automatically convert ITN to zITN
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex* const pindexPrev)
{
    ...
    if (nHeight > Params().Zerocoin_StartHeight()) {
        ...
        for (const CTransaction& tx : block.vtx) {
            ...
            // double check that there are no double spent zITN spends in this block
            if (tx.IsZerocoinSpend()) {
                for (const CTxIn txIn : tx.vin) {
                    if (txIn.scriptSig.IsZerocoinSpend()) {
                        libzerocoin::CoinSpend spend = TxInToZerocoinSpend(txIn);
                        if (count(vBlockSerials.begin(), vBlockSerials.end(), spend.getCoinSerialNumber()))
                            return state.DoS(100, error("%s : Double spending of zITN serial %s in block\n Block: %s",
...
bool ProcessNewBlock(CValidationState& state, CNode* pfrom, CBlock* pblock, CDiskBlockPos* dbp)
{
    ...
    if (nMints || nSpends)
        LogPrintf("%s : block contains %d zITN mints and %d zITN spends\n", __func__, nMints, nSpends);
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == NetMsgType::VERSION) {
        ...
        if (pfrom->cleanSubVer == "/ITN Core:1.1.0/" ||
            pfrom->cleanSubVer == "/ITN Core:1.3.0/" ||
            pfrom->cleanSubVer == "/ITN Core:1.3.1/") {
            LOCK(cs_main);
        ...
        // ITN: We use certain sporks during IBD, so check to see if they are
