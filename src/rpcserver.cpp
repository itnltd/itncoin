...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ITN features */
        {"itn", "masternode", &masternode, true, true, false},
        {"itn", "listmasternodes", &listmasternodes, true, true, false},
        {"itn", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"itn", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"itn", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"itn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"itn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"itn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"itn", "masternodedebug", &masternodedebug, true, true, false},
        {"itn", "startmasternode", &startmasternode, true, true, false},
        {"itn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"itn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"itn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"itn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"itn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"itn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"itn", "mnbudget", &mnbudget, true, true, false},
        {"itn", "preparebudget", &preparebudget, true, true, false},
        {"itn", "submitbudget", &submitbudget, true, true, false},
        {"itn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"itn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"itn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"itn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"itn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"itn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"itn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"itn", "checkbudgets", &checkbudgets, true, true, false},
        {"itn", "mnsync", &mnsync, true, true, false},
        {"itn", "spork", &spork, true, true, false},
        {"itn", "getpoolinfo", &getpoolinfo, true, true, false},
        {"itn", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzitnseed", &getzitnseed, false, false, true},
        {"zerocoin", "setzitnseed", &setzitnseed, false, false, true}
...
{
    return "> itn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21177/\n";
}
