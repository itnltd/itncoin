...
#   c) node1 mines 32 blocks, so now node 0 has 60001itn, node 1 has 4250itn, node2 has none.
#   d) node0 sends 601 ITN to node2, in two transactions (301 ITN, then 300 ITN).
