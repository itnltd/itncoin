...
RESOURCES += src/qt/itn.qrc src/qt/itn_locale.qrc

TRANSLATIONS += src/qt/locale/itn_bg.ts \
                src/qt/locale/itn_de.ts \
                src/qt/locale/itn_en.ts \
                src/qt/locale/itn_es.ts \
                src/qt/locale/itn_fi.ts \
                src/qt/locale/itn_fr.ts \
                src/qt/locale/itn_it.ts \
                src/qt/locale/itn_ja.ts \
                src/qt/locale/itn_pl.ts \
                src/qt/locale/itn_pt.ts \
                src/qt/locale/itn_ru.ts \
                src/qt/locale/itn_sk.ts \
                src/qt/locale/itn_sv.ts \
                src/qt/locale/itn_vi.ts \
                src/qt/locale/itn_zh_CN.ts \
                src/qt/locale/itn_zh_TW.ts
