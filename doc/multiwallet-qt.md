...
In order to support loading of multiple wallets in itn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is itn.cpp.
...
Changes to itn.cpp
----------------------
itn.cpp is the entry point into itn-qt, and as such, will require some minor modifications to provide hooks for
